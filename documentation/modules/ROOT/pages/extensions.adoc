...
Take note of the cluster details in the url of the browser. It will be something like this:
[source,none]
----
 https://console-openshift-console.apps.sandbox-m2.ll9k.p1.openshiftapps.com/add/ns/yourusername-dev
----
