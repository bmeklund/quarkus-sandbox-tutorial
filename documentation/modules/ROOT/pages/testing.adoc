...
To show up the public endpoints, select `Show plug-in endpoints`. Then, unfold the `ENDPOINTS > Public` and select the *User port forward(8080)* icon. In the page that opens add the */q/dev* at the end of the url to open the Dev UI.
