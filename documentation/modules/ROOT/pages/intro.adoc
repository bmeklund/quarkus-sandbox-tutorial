...
* *Git Repo URL*: `https://github.com/bmeklund/quarkus-workshop-m1m2-labs/tree/sandbox-rhbq3.20`
...
Also click *Yes and/or Approve* on any other pop up dialogs in the low right corner.  
